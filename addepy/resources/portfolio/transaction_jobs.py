...
class TransactionJobsResource(BaseResource):
    ...
    def iter_jobs(
        ...
        *,
        ...
        """
        Iterate over transaction jobs lazily.
        ...
        Yields:
            Individual transaction job resource objects.
        """
        return self._paginate("/transaction_jobs", page_limit=page_limit, max_items=limit)
